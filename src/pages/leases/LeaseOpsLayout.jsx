...
import { FileCheck, History, FileText } from "lucide-react";
import { useEffect, useState } from "react";
import { agreementsAPI, leaseAmendmentsAPI, leaseLinkedDocumentsAPI } from "../../services/api";
...
export default function LeaseOpsLayout() {
  ...
  useEffect(() => {
    Promise.all([
      ...
      .then(([agreements, amendments, documents]) => {
  ...
  return (
    <div>
      ...
      <div className="flex items-baseline gap-2 mb-4">
        <h1 className="text-xl font-semibold text-gray-800">Lease Operations</h1>
        <span className="text-sm text-gray-400">—</span>
        <p className="text-sm text-gray-500">Manage lease agreements, amendments and linked documents</p>
      </div>
